...
def main():
    ...
    st.write(st.session_state.show_app)
    ...
    if st.session_state.show_app:
        ...
        # ... (rest of your code)
                ...
                selected_option = st.sidebar.radio("Select an option",
                                                   ["View Items", "Add Item", "Purchase Item", "Search Item",
                                                    "Add to Cart",
                ...
                if selected_option == "View Items":
                                ...
                                for cart_item in cart:
                                    if cart_item["name"].lower() == item['name'].lower():
                                        ...
                                        if total_quantity <= item['quantity']:
                                            ...
                                            st.success(
                                                f"{quantity_to_add} {item['name']} added to the cart successfully.")
                                    ...
                                    if quantity_to_add <= item['quantity']:
                                        cart_item = {"name": item['name'], "quantity": quantity_to_add,
                                                     "price": item['price']}
                    ...
                    if len(cart) != 0:
                        items_to_remove = st.multiselect("Select items to remove from the cart",
                                                         [item["name"] for item in cart])
